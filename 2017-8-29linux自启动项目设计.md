...
start() {  
   ...
   if [ $psid -ne 0 ]; then  
      ...
      JAVA_CMD="java -Djava.ext.dirs=lib -Xmx512m -Xms512m -jar /home/pengxx/javaProject/UApp/fetch-umeng-data.jar &"  
